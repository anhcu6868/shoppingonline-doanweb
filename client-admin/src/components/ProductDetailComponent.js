          ...
          <table>
            <tbody>
              ...
              <tr>
                <td></td>
                <td>
                  <input className='btn btn-success mt-2' type="submit" value="ADD NEW" onClick={(e) => this.btnAddClick(e)} />
                  <input className='btn btn-warning mt-2' type="submit" value="UPDATE" onClick={(e) => this.btnUpdateClick(e)} />
                  <input className='btn btn-danger mt-2' type="submit" value="DELETE" onClick={(e) => this.btnDeleteClick(e)} />
                </td>
              </tr>
              <tr>
